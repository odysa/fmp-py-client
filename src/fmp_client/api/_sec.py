...
class SECMixin:
    ...
    async def sec_filings_company_search_name(self, name: str) -> JSONArray:
    ...
    async def sec_filings_company_search_cik(self, cik: str) -> JSONArray:
    ...
    async def industry_classification_search(self, name: str) -> JSONArray:
